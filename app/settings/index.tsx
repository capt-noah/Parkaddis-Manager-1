    ...
    >
        ...
        >
          ...
          <View className="flex-row items-center gap-4 mb-6">
            ...
            <Text className="text-xl font-headline font-bold text-slate-900 dark:text-white tracking-tight">
              Settings
            </Text>
          </View>
        ...
        <View className="gap-3 w-full mt-4">
          {themeOptions.map((option) => (
            ...
            >
              <View className="flex-row items-center gap-4">
                <View
                  className={`w-12 h-12 rounded-xl ${option.bg} items-center justify-center shadow-sm`}
                >
                  <option.icon size={24} color={option.color} />
                </View>
                <View>
                  <Text
                    className={`text-sm font-bold ${currentTheme === option.id ? "text-primary" : "text-slate-900 dark:text-white"}`}
                  >
                    {option.title}
                  </Text>
                  <Text className="text-[10px] text-slate-400 dark:text-slate-500 font-medium uppercase tracking-wide">
